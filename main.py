...
col00, col11x, col0x, col10x = st.columns([1.85,1.75,1.75,5.75])
with col00:
    st.markdown('[![Foo](https://raw.githubusercontent.com/vitt0/sunflower-land/main/sflplus.png)](https://sflplus.info)  <span style="vertical-align:bottom;color:rgb(0, 221, 66);font-weight:bold;">v3.1</span>', unsafe_allow_html=True)
with col11x:
...
tab5, tab6, tab7, tab8, tab9, tab10  = st.tabs(["💾HOME", "🏆RANKING", "👥BUMPKIN", "💸TRADER", "👨‍🔬CALCULATOR", "📜NFT LIST"])
...
with tab8:
    ...
    crops = [
        ...
        },
        {
            ...
            "offerPrice": 0,
            "url": "435",
            "urlImg": "https://i.seadn.io/gcs/files/7d3a80576797b264c0704e71629f3275.png?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
        {
        ...
        },
        {
            ...
            "offerPrice": 0,
            "url": "418",
            "urlImg": "https://i.seadn.io/gcs/files/50c63763c89010e5b4dd1f8bbe71f3a8.png?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
        {
            ...
            "offerPrice": 0,
            "url": "410",
            "urlImg": "https://i.seadn.io/gcs/files/1c272d6cb5ff87fc19fb985b292a9323.png?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
        {
            ...
            "offerPrice": 0,
            "url": "419",
            "urlImg": "https://i.seadn.io/gcs/files/4d9907e9db06bd21018690a44920edf8.png?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
        {
            ...
            "offerPrice": 0,
            "url": "448",
            "urlImg": "https://i.seadn.io/gcs/files/46c3891d1c0b7a64bbe295bea122a9c3.png?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
        {
            ...
            "offerPrice": 0,
            "url": "420",
            "urlImg": "https://i.seadn.io/gcs/files/1f3bc72b9fef92024deadbce39cb44c2.png?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
        {
            ...
            "offerPrice": 0,
            "url": "404",
            "urlImg": "https://i.seadn.io/gcs/files/c01d91c4cb22d12f54ca2b9cad011f3a.png?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
        {
            ...
            "offerPrice": 0,
            "url": "421",
            "urlImg": "https://i.seadn.io/gcs/files/09aa31be98562261634f0033d4314d02.gif?auto=format&w=384",
            "collection": "Sunflower Land Collectibles",
            "isSelling": True,
        },
    ]
    ...
    for index, crop in enumerate(crops):
        markdown_content = """
                <div class="card text-white bg-gray-dark mb-3" style="max-width: 25rem;">
                  <a href="{}{}" style="display: inline-block" target="_blank">
                    <img src="{}" alt="NFT Image" class="card-img-top" alt="..."></a>
                    <span class="w-100 p-1 bg-secondary position-relative bottom-0 text-center"><span class="h5 badge text-center rounded-pill bg-success start-50">Crop</span></span>                 
                  <div class="card-body">
