...
with col00:
    st.markdown('[![Foo](https://sflplus.info/sflplus.png)](https://sflplus.info)  <span style="vertical-align:bottom;color:rgb(0, 221, 66);font-weight:bold;">v3.2</span>', unsafe_allow_html=True)
with col11x:
                ...
                if delivery_data:
                    for index, order in enumerate(delivery_data, start=1):
                        ...
                        if items:
                            ...
                            deliveryItems_value = "\n".join([f"{value}x {key}" for key, value in items.items()])
                        else:
                            deliveryItems = ""
                            deliveryItems_value = ""
...
async def main():
    try:
        ...
        if data1 is not None:
            ...
            df3 = df3.sort_values(by='Points', ascending=False)    #['Bottles', 'Iron C.', 'Seaweed'], ascending=[False, False, False], kind='mergesort')
