...
def process_ranking_data(data1):
    if data1 is not None:
        df1, df2, df3 = process_data(data1)
        display_data(df1, df2, df3)

async def process_data(data1):
    if data1 is not None:
        df1 = pd.DataFrame({
