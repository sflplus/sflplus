    ...
    def display_nft_cards(nft_list):
        ...
        for item in nft_list:
            ...
            <div class="card rounded border-top border-5 border-dark text-white bg-dark mb-5 h-100" style="max-width: 25rem;">            
                ...
                <button type="button" class="position-absolute top-0 start-0 mt-2 ml-2 btn btn-sm btn-secondary d-md-none" style="width: 3rem; height:2.2rem;opacity:0.75;"><h6><b>#{}</b></h6></button>
